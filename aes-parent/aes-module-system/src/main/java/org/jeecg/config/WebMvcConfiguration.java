...
import com.aoyang.common.interceptor.EhomeTokenInterceptor;
...
public class WebMvcConfiguration implements WebMvcConfigurer {
	...
	@Autowired
	private EhomeTokenInterceptor ehomeTokenInterceptor;
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		// 澳洋e家前端项目拦截器
		registry.addInterceptor(ehomeTokenInterceptor).addPathPatterns("/api/ehome/**");
	}
}
