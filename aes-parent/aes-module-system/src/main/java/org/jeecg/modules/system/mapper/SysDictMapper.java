...
public interface SysDictMapper extends BaseMapper<SysDict> {
     ...
     * @return
     */
    public String queryTableDictTextBySql(@Param("table") String table, @Param("text") String text, @Param("code") String code, @Param("key") String key, @Param("filterSql") String filterSql);
