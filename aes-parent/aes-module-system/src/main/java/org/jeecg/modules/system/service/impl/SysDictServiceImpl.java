...
public class SysDictServiceImpl extends ServiceImpl<SysDictMapper, SysDict> implements ISysDictService {
    ...
    public String queryTableDictTextByKey(String table, String text, String code, String key) {
        log.info("无缓存dictTable的时候调用这里！talbe={},text={},code={},key={}", table, text, code, key);
    ...
    @Override
	@Cacheable(value = CacheConstant.SYS_DICT_TABLE_CACHE)
    public String queryTableDictTextByKey(String table, String text, String code, String key, String filterSql) {
        log.info("无缓存dictTable的时候调用这里！talbe={},text={},code={},key={},sql={}", table, text, code, key, filterSql);
        return sysDictMapper.queryTableDictTextBySql(table, text, code, key, filterSql);
    }
